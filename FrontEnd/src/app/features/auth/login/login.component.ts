  ...
  template: `
    <div class="login-container">
      <div class="login-card">
        <div class="logo">
          <img src="/logo2.PNG" alt="Studio & Style" />
        </div>
          ...
          <div class="form-actions">
            ...
            >
              <i
                ...
                [class.fa-sign-in-alt]="!isLoading"
              ></i>
  ...
  styles: [
    `
      ...
      .login-container {
        ...
        background: vars.$background-brown-gold;
      ...
      .login-card {
        ...
        background: vars.$background-off-white;
...
export class LoginComponent {
  ...
  onSubmit(): void {
    ...
    this.authService.login(this.email, this.password).subscribe({
      ...
      error: (error) => {
        this.errorMessage = 'Login e senha incorretos';
