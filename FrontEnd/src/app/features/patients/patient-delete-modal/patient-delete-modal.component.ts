      ...
      <div class="modal-container" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div class="confirmation-message">
            <h4>Tem certeza que deseja excluir este paciente?</h4>
          ...
          <div class="warning-text">
            ...
            <span>Esta ação removerá permanentemente o paciente e todos os dados associados.</span>
          </div>
        </div>
...
export class PatientDeleteModalComponent {
  ...
  confirmDelete(): void {
    if (this.patient) {
      this.confirm.emit(this.patient);
    }
  }
}
