      ...
      <div class="modal-container" (click)="$event.stopPropagation()">
        ...
        <div class="modal-body">
          ...
          <div class="schedule-info" *ngIf="schedule">
            <div class="info-card">
              ...
              <div class="info-item">
                ...
                <span>{{
                  schedule.date_and_houres | date : 'dd/MM/yyyy HH:mm'
                }}</span>
              </div>
              ...
              <div class="info-item" *ngIf="schedule.provider">
                ...
                <span
                  ...
                  {{ schedule.provider.lastname }}</span
                >
              </div>

              <div
                class="info-item"
                *ngIf="schedule.Services && schedule.Services.length > 0"
              >
                <label>
                ...
                <div class="services-list">
                  <span
                    class="service-badge"
                    *ngFor="let service of schedule.Services"
                  >
                    {{ service.service }}
                  </span>
                </div>
          ...
          <div class="warning-text">
            ...
            <span
              >Esta ação removerá permanentemente o agendamento e todos os dados
              associados.</span
            >
          </div>
        </div>
